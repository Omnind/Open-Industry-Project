...
func _enter_tree() -> void:
	_menu_bar = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@EditorTitleBar@15/@MenuBar@111")
	_project_popup_menu = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@EditorTitleBar@15/@MenuBar@111/Project")
	_editor_popup_menu = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@EditorTitleBar@15/@MenuBar@111/Editor")
	_help_popup_menu = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@EditorTitleBar@15/@MenuBar@111/Help")
	
	_title_bar = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@EditorTitleBar@15")
	_center_buttons = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@EditorTitleBar@15/@HBoxContainer@4053")
	_editor_run_bar_container = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@EditorTitleBar@15/@EditorRunBar@4134")
	_renderer_selection = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@EditorTitleBar@15/@HBoxContainer@4135")
	
	_separator = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@HSplitContainer@17/@HSplitContainer@25/@HSplitContainer@33/@VBoxContainer@34/@VSplitContainer@36/@VSplitContainer@62/@VBoxContainer@63/@PanelContainer@110/MainScreen/@Node3DEditor@10009/@MarginContainer@9464/@HFlowContainer@9465/@HBoxContainer@9466/@VSeparator@9481")
	_camera_button = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@HSplitContainer@17/@HSplitContainer@25/@HSplitContainer@33/@VBoxContainer@34/@VSplitContainer@36/@VSplitContainer@62/@VBoxContainer@63/@PanelContainer@110/MainScreen/@Node3DEditor@10009/@MarginContainer@9464/@HFlowContainer@9465/@HBoxContainer@9466/@Button@9482")
	
	_debugger_button = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@HSplitContainer@17/@HSplitContainer@25/@HSplitContainer@33/@VBoxContainer@34/@VSplitContainer@36/@PanelContainer@6819/@VBoxContainer@6820/@HBoxContainer@6821/@HBoxContainer@6822/@Button@8447")
	_audio_button = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@HSplitContainer@17/@HSplitContainer@25/@HSplitContainer@33/@VBoxContainer@34/@VSplitContainer@36/@PanelContainer@6819/@VBoxContainer@6820/@HBoxContainer@6821/@HBoxContainer@6822/@Button@10932")
	_animation_button = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@HSplitContainer@17/@HSplitContainer@25/@HSplitContainer@33/@VBoxContainer@34/@VSplitContainer@36/@PanelContainer@6819/@VBoxContainer@6820/@HBoxContainer@6821/@HBoxContainer@6822/@Button@9274")
	_godot_version = get_node("/root/@EditorNode@17165/@Panel@13/@VBoxContainer@14/@HSplitContainer@17/@HSplitContainer@25/@HSplitContainer@33/@VBoxContainer@34/@VSplitContainer@36/@PanelContainer@6819/@VBoxContainer@6820/@HBoxContainer@6821/@VBoxContainer@6828")
...
func _toggle_native_mode(native_mode: bool) -> void:	
	...
	_godot_version.visible = native_mode
